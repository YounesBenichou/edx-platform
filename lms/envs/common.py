...
from openedx.core.constants import (
    COURSE_KEY_REGEX,
    COURSE_KEY_PATTERN,
    COURSE_ID_PATTERN,
)
...
def _make_mako_template_dirs(settings):
    ...
    if settings.ENABLE_COMPREHENSIVE_THEMING:
        themes_dirs = get_theme_base_dirs_from_settings(
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            COMMON_ROOT / "djangoapps" / "pipeline_mako" / "templates",
            COMMON_ROOT
            / "static",  # required to statically include common Underscore templates
        ],
...
ENABLE_MULTICOURSE = (
    False  # set to False to disable multicourse display (see lib.util.views.edXhome)
)
...
USERNAME_PATTERN = rf"(?P<username>{USERNAME_REGEX_PARTIAL})"
...
from xmodule.modulestore.edit_info import (
    EditInfoMixin,
)  # lint-amnesty, pylint: disable=wrong-import-order, wrong-import-position
...
CODE_JAIL_REST_SERVICE_REMOTE_EXEC = (
    "xmodule.capa.safe_exec.remote_exec.send_safe_exec_request_v0"
)
...
TRANSLATORS_GUIDE = (
    "https://edx.readthedocs.org/projects/edx-developer-guide/en/latest/"
...
from lms.djangoapps.course_wiki import (
    settings as course_wiki_settings,
...
from openedx.core.lib.rooted_paths import (
    rooted_glob,
)  # pylint: disable=wrong-import-position
...
instructor_dash_js = sorted(
    rooted_glob(PROJECT_ROOT / "static", "js/instructor_dashboard/**/*.js")
)
...
PIPELINE["JAVASCRIPT"] = {
    ...
    "module-descriptor-js": {
        "source_filenames": rooted_glob(
            COMMON_ROOT / "static/", "xmodule/descriptors/js/*.js"
        ),
        "output_filename": "js/lms-module-descriptors.js",
    },
    "module-js": {
        "source_filenames": rooted_glob(
            COMMON_ROOT / "static", "xmodule/modules/js/*.js"
        ),
    ...
    "reverify": {"source_filenames": reverify_js, "output_filename": "js/reverify.js"},
    "incourse_reverify": {
        "source_filenames": incourse_reverify_js,
        "output_filename": "js/incourse_reverify.js",
    },
    "ccx": {"source_filenames": ccx_js, "output_filename": "js/ccx.js"},
    "footer_edx": {
...
PASSWORD_POLICY_COMPLIANCE_ROLLOUT_CONFIG = {"ENFORCE_COMPLIANCE_ON_LOGIN": False}
...
ACCOUNT_VISIBILITY_CONFIGURATION["admin_fields"] = ACCOUNT_VISIBILITY_CONFIGURATION[
    "custom_shareable_fields"
] + [
    "email",
    "id",
...
RSS_PROXY_CACHE_TIMEOUT = (
    3600  # The length of time we cache RSS retrieved from remote URLs in seconds
)
...
FINANCIAL_ASSISTANCE_APPLICATION_STATUS_URL = (
    "/core/api/financial_assistance_application/status/"
)
CREATE_FINANCIAL_ASSISTANCE_APPLICATION_URL = (
